...
public class ProductFirebase {
    ...
    public ProductFirebase(String image, String description, String sellingPrice, String remarks, String BV, String distributorName, String distributorCode, String distributorPhone, String quantity, int totBv, float totPrice) {
        this.image = image;
